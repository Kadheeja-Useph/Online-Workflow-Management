    ...
    <div class="main">
        ...
        <li><a href="search1.php">SEARCH FOR TRADEPERSON</a><b></li>
          ...
          <li><a href="respond.php">NOTIFICATION</a></li>
            <li><a href="prev.php"> PREV NOTIFICATION</a></li>
...
session_start();
 ...
 $Uid=$_SESSION["Uid"];
 $result=$conn->query("select * from request where Uid=$Uid and prev=1");
                       ...
                       while($row=mysqli_fetch_assoc($result1))
                    {
                           echo "your request accepted<br>
                            ...
                            "<br>Trade:".$row["Trade"].
                             ...
                             ?>
                    <br><a href="delete.php?id=<?php echo $s ?>">ok</a><hr>
                   <?php
                    }
                }
            }
                if($row["Status"]=="reject")
            {
                 ...
                 if($result1->num_rows>0)
                {
                    ...
                    if($result1->num_rows>0)
                   {
                          while($row=mysqli_fetch_assoc($result1))
                       {
                              echo "your request pending<br>
                               Name:".$row["Name"].
                               "<br>Trade:".$row["Trade"]."<br><hr>";
                       }
                   }
               }
